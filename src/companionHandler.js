...
function handleCompanion(problem) {
  ...
  if (vscode.workspace.workspaceFolders === undefined) {
    ...
    vscode.commands.executeCommand("extension.showWorkspaceError");
  } else {
    ...
    selectLanguage
      .then(async (language) => {
        ...
        if (!ext) throw Error("Extension not found");
      ...
      .then(undefined, (err) => {
        ...
        vscode.window.showErrorMessage(
          "Error while creating file. Are you sure you have the correct permissions ?"
        );
        return -1;
      });
  }
